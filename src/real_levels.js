...
import {GravityPlanet, ControlPlanet, ForbiddenPlanet, EndPlanet} from './scene'
...
levels.push((scene) => {
  ...
  scene.gravityPlanets = [
    new ControlPlanet({x: unit, y: unit}, 0.2),
  ]
  scene.endPlanets = [
...
levels.push((scene) => {
  ...
  scene.gravityPlanets = [
    new ControlPlanet({x: unit / 2, y: unit}, 0.2),
  ]
  scene.endPlanets = [
...
levels.push((scene) => {
  ...
  scene.gravityPlanets = [
    new ControlPlanet({x: unit / 2, y: unit * 1.5}, 0.2),
  ]
  scene.endPlanets = [
...
levels.push((scene) => {
  ...
  scene.gravityPlanets = [
    new ControlPlanet({x: unit / 2, y: unit * 2}, 0.2),
  ]
  scene.endPlanets = [
...
levels.push((scene) => {
  ...
  scene.gravityPlanets = [
    new ControlPlanet({x: unit / 2, y: unit * 2.5}, 0.2),
  ]
  scene.endPlanets = [
...
levels.push((scene) => {
  ...
  scene.gravityPlanets = [
    new ControlPlanet(scale({x: -5, y: 5}, 0.75), 0.2),
    new ControlPlanet(scale({x: 5, y: 5}, 0.75), 0.2),
  ]
  scene.endPlanets = [
...
levels.push((scene) => {
  ...
  scene.gravityPlanets = [
    new ControlPlanet(scale({x: -10, y: 5}, 0.75), 0.2),
    new ControlPlanet(scale({x: 0, y: 5}, 0.75), 0.2),
    new ControlPlanet(scale({x: 0, y: -5}, 0.75), 0.2),
  ]
  scene.endPlanets = [
...
levels.push((scene) => {
  ...
  scene.gravityPlanets = [
    new ControlPlanet(scale({x: -10, y: 10}, 0.75), 0.2),
    new ControlPlanet(scale({x: -10, y: 0}, 0.75), 0.2),
    new ControlPlanet(scale({x: 0, y: 0}, 0.75), 0.2),
    new ControlPlanet(scale({x: 0, y: -10}, 0.75), 0.2),
  ]
  scene.endPlanets = [
...
levels.push((scene) => {
  ...
  scene.gravityPlanets = [
    new ControlPlanet(scale({x: -10, y: 10}, 0.75), 0.2),
    new ControlPlanet(scale({x: -10, y: 0}, 0.75), 0.2),
    new ControlPlanet(scale({x: 0, y: 0}, 0.75), 0.55),
    new ControlPlanet(scale({x: 0, y: -10}, 0.75), 0.2),
  ]
  scene.endPlanets = [
    new EndPlanet(scale({x: 10, y: -10}, 0.75), 1),
...
levels.push((scene) => {
  ...
  scene.gravityPlanets = [
    new ControlPlanet(scale({x: -10, y: 10}, 0.75), 0.2),
    new ControlPlanet(scale({x: -10, y: 0}, 0.75), 0.2),
    new ControlPlanet(scale({x: 0, y: 0}, 0.75), 0.9),
    new ControlPlanet(scale({x: 0, y: -10}, 0.75), 0.2),
  ]
  scene.endPlanets = [
    new EndPlanet(scale({x: 10, y: -10}, 0.75), 1),
...
levels.push((scene) => {
  ...
  scene.player.position = scale({x: 0, y: 10}, 0.75)
  scene.gravityPlanets = [
    new ControlPlanet(scale({x: 0, y: 10}, 0.75), 0.9),
    new ControlPlanet(scale({x: 0, y: 0}, 0.75), 0.9),
  ]
  scene.endPlanets = [
    new EndPlanet(scale({x: 0, y: -10}, 0.75), 1),
...
function mkSwing(name, mkAngle: (number) => number) {
  return (scene) => {
    ...
    scene.gravityPlanets = [
      new ControlPlanet(origin(), 0.1, unit),
    ]
...
levels.push((scene) => {
  ...
  for (let x = -5; x < 5; x++) {
    scene.gravityPlanets.push(
      new ControlPlanet({x: unit * x, y: unit * - x * 3 / 5}, 0.1),
    )
  }
  scene.endPlanets = [
...
function mkOrbit({name, player}) {
  return (scene) => {
    ...
    scene.gravityPlanets = [
      new ControlPlanet(player(u), 0.2)
    ]
    ...
    for (let i = 0; i < length; i++) {
      ...
      const planet = new ControlPlanet(position, 0.6)
...
levels.push((scene) => {
  ...
  const influence = 5
  scene.gravityPlanets = [
    new ControlPlanet(_.cloneDeep(scene.player.position), 0.2),
    new ControlPlanet({x: 0, y: -u}, radius, influence),
    new ControlPlanet({x: 0, y: u}, radius, influence),
  ]
})
...
levels.push((scene) => {
  ...
  const u = 10
  scene.gravityPlanets.push(new ControlPlanet(_.cloneDeep(scene.player.position), 0.5))
...
levels.push((s) => {
  s.name = 'pills'
  const u = 10
  s.gravityPlanets.push(new ControlPlanet({x: 0, y: 0}, 0.3))
...
levels.push((s) => {
  ...
  s.gravityPlanets = [
    new ControlPlanet({x: 0, y: u}, 0.3),
    new ControlPlanet({x: u, y: 0}, 0.3),
    new ControlPlanet({x: -u, y: 0}, 0.3),
  ]
...
function mkAxis(name: string, custom: (Scene, number) => void) {
  return (s) => {
    ...
    const u = 10
    s.player.position = {x: 0, y: u}
    s.gravityPlanets.push(new ControlPlanet({x: 0, y: u}, 0.4))
    custom(s, u)
...
const detour = (name, custom) => (s) => {
  ...
  s.gravityPlanets = [
    new ControlPlanet({x: -u, y: u}, 0.3),
    new ControlPlanet({x: 0, y: u}, 0.3),
    new ControlPlanet({x: u, y: u}, 0.3),
    new ControlPlanet({x: 2 * u, y: 0}, 0.3),
    new ControlPlanet({x: u, y: -u}, 0.3),
    new ControlPlanet({x: 0, y: -u}, 0.3),
  ]
...
levels.push(detour('detour 2', (s, u) => {
  s.gravityPlanets.push(new ControlPlanet({x: -2 * u, y: -2 * u}, 0.3))
}))
